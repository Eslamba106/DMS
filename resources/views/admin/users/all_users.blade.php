...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <button type="submit" name="bulk_action_btn" value="delete" class="btn btn-danger delete_confirm mt-3 mr-2"> <i class="la la-trash"></i> {{__('dashboard.delete')}}</button>
        </div>
        </div>
        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $user->name }}</td>
                        <td> <span class="badge badge-pill {{ ($user->status == 'active') ? "badge-success" : "badge-danger" }}">{{ $user->status }}</span> </td>
