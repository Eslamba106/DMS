                        ...
                        <div class="col-12">
                            <form enctype="multipart/form-data" class="form-horizontal m-t-20" action="{{ route('register') }}" method="POST">
                                ...
                                <div class="form-group row ">
                                    <div class="col-12 ">
                                        <input class="form-control form-control-lg" type="text" name="name" required=" " placeholder="{{ __('login.name') }}">
                                    </div>
                                </div>
                                {{-- <div class="form-group row ">
                                    <div class="col-12 ">
                                        <input class="form-control form-control-lg" type="text" name="phone" required=" " placeholder="Phone">
                                    </div>
                                </div> --}}
                                {{-- <div class="custom-file from-group mb-3">
                                    <input type="file" class="custom-file-input" name="image" id="inputGroupFile01">
                                    <label class="custom-file-label" for="inputGroupFile01" >{{ __('login.image') }}</label>
                                </div> --}}
                                
                                <div class="form-group row">
                                    <div class="col-12 ">
                                        <input class="form-control form-control-lg" name="email"  type="email" required=" " placeholder="{{ __('login.email') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-12 ">
                                        <input class="form-control form-control-lg" name="password"  type="password" required=" " placeholder="{{ __('login.password') }}">
                                    </div>
                                </div>
